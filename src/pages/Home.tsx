...
export default function Home() {
  ...
  const teacherNames =
    lang === "bn"
      ? ["আব্দুর রাজ্জাক","মো: ইয়াসীন আলি","হাফেজ মাওলানা শাহজাহান","ক্বারী ইবরাহিম খলিল","মাসুদ রানা ","হাফেজ মাসুদুর রহমান","মোঃরেজাউল করিম ","হাফেজ ইব্রাহিম","শরিফুল ইসলাম ","আল মামুন","তৌফিকুর রহমান আরেফিন","হাফেজ মাওলানা ওয়ালিউল্লাহ"]
      : lang === "ar"
