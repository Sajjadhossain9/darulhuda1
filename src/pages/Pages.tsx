...
export function Teachers() {
  const { t, lang } = useApp();
  const names = lang === "bn"
    ? ["আব্দুর রাজ্জাক","মো: ইয়াসীন আলি","হাফেজ মাওলানা শাহজাহান","ক্বারী ইবরাহিম খলিল","মাসুদ রানা ","হাফেজ মাসুদুর রহমান","মোঃরেজাউল করিম ","হাফেজ ইব্রাহিম","শরিফুল ইসলাম ","আল মামুন","তৌফিকুর রহমান আরেফিন","হাফেজ মাওলানা ওয়ালিউল্লাহ","মোছাঃ শিউলি আখতার","মোছাঃ সীমা আখতার"," মোছাঃ লাকি আকতার","মোছাঃ দিল আফরোজা বেগম","হাফেজ ইসমাইল","মাওলানা মামুন","হাফেজ হোসাইন ","মাওলানা শাহ আলম","মাওলানা আব্দুল্লাহ"]
    : lang === "ar"
...
export function Scholars() {
  const { lang } = useApp();
  const items = lang==="bn"?[
    { name:"ডা. নুর নবী আনসারী", text:"মাদরাসা দারুল হুদার শিক্ষাব্যবস্থা প্রশংসনীয়।" },
    { name:"শায়খ আহমাদুল্লাহ", text:"একটি আদর্শ ইসলামিক প্রতিষ্ঠান।" },
    { name:"শায়খুল হাদিস জয়নুল আবেদিন", text:"কুরআন ও সুন্নাহর শিক্ষায় অগ্রগণ্য।" },
    { name:"মুফতি নাজমুল হক", text:"আখলাকের প্রতি বিশেষ মনোযোগ লক্ষণীয়।" },
  ]:lang==="ar"?[
